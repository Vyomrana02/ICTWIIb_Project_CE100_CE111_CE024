...
<div style='clear: both;'/>
    ...
    <!-- <div style="overflow: hidden;">
            ...
            try{
                ...
                <div class="content"  style="">
                 ...
                 <input type="hidden" name="itemid" value="<?php echo $result->id; ?>">
                    ...
                    <h6>₹ <?php  echo $result->price;?></h6><br>
                    <h6><?php echo $result->address; ?></h6>
                    <h6><?php echo $result->phone_no; ?></h6>
        ...
        <input id="sub" type="submit" name="submit" value="Delete item from Sellings">
      </div>
      </form> 
...
<?php
                ...
                if($count==0){
                    ...
                    echo "<a href='homepage.php'>here</a>";
                }

    ...
    <div class="container">
      ...
      <div class="content">
        <div class="user-details">
          ...
          <div class="input-box">            
            <span class="details">Enter the name of the product to sell</span>
                    <input type="text" class="sell" name="product_name" value="" placeholder="Product name" required>
                    </div>
                    <div class="input-box">
                    <span class="details">Enter Your Name(if you want to give another name)</span>
                   <input type="text" class="sell" name="seller_name" value="<?php echo $seller_name; ?>" required>
                  </div>
                  <div class="input-box">            
            <span class="detail">Enter Your Address</span>
                    <input type="text" class="sell" name="seller_address" value="<?php echo $address ?>" required>
                    </div>
                    <div class="input-box">            
            <span class="detail">Enter Your Phone Number</span>
                    <input type="number" class="sell" name="phone_no" value="<?php echo $seller_phone; ?>" required>
                    </div>
                    <div class="input-box">            
            <span class="detail">Enter Your Email</span>
                    <input type="text" class="sell" name="seller_email" value="<?php echo $seller_email; ?>" required>
                    </div>
                    <div class="input-box">            
            <span class="detail">Enter The Price:</span></td>
                    <input type="number"  class="sell" name="price" value="" placeholder="Enter amount Rupees" required>
                    </div>
                    <div class="input-box">            
            <span class="detail">Upload Your Selling Image Here</span>
                    <input type="file" class="sell" name="uploadfile" value="">
                    </div>
                    <div class="input-box">            

...
<div style='clear: both;'/>
    ...
    <div class="content" >
      ...
      <!-- //  <h3><?php echo $result->id; ?></h3> -->
        ...
        <h6>Price: <?php  echo $result->price;?></h6>
        <h6 >Name: <?php echo $result->buyer_name; ?></h6><hr>
        <h6 >Addres: <?php echo $result->buyer_address; ?></h6><hr>
        <h6 >Email: <?php echo $result->buyer_email; ?></h6>
        <h6 >Phone: <?php echo $result->buyer_phone_no; ?></h6>
